...
public class ValidationSupportValueSetTest {
    ...
    public void testCheckValueSetBindingStringValid1() {
        ValidationSupport.checkValueSetBinding((net.sovrinhealth.fhir.model.type.String)null, "elementName", "valueSetUrl", null, "code1");
    }

    @Test
    public void testCheckValueSetBindingStringValid2() {
        ValidationSupport.checkValueSetBinding(net.sovrinhealth.fhir.model.type.String.of("code1"), "elementName", "valueSetUrl", null, "code1");
    }

    @Test
    public void testCheckValueSetBindingStringValid3() {
        ValidationSupport.checkValueSetBinding(net.sovrinhealth.fhir.model.type.String.builder().extension(Extension.builder().url("http://hl7.org/fhir/StructureDefinition/data-absent-reason").value(Code.of("unknown")).build()).build(), "elementName", "valueSetUrl", null, "code1");
    }

    @Test
    public void testCheckValueSetBindingStringNotValid1() {
        try {
            ValidationSupport.checkValueSetBinding(net.sovrinhealth.fhir.model.type.String.of("code1"), "elementName", "valueSetUrl", null);
            fail();
        } catch (IllegalStateException e) {}
    }
    ...
    public void testCheckValueSetBindingStringNotValid2() {
        try {
            ValidationSupport.checkValueSetBinding(net.sovrinhealth.fhir.model.type.String.of("code1"), "elementName", "valueSetUrl", null, "code2");
            fail();
        } catch (IllegalStateException e) {}
    }
    ...
    public void testCheckValueSetBindingStringsValid() {
        ValidationSupport.checkValueSetBinding(Arrays.asList(net.sovrinhealth.fhir.model.type.String.of("code1"), net.sovrinhealth.fhir.model.type.String.of("code2")), "elementName", "valueSetUrl", null, "code1", "code2");
    }

    @Test
    public void testCheckValueSetBindingStringsNotValid() {
        try {
            ValidationSupport.checkValueSetBinding(Arrays.asList(net.sovrinhealth.fhir.model.type.String.of("code1"), net.sovrinhealth.fhir.model.type.String.of("code2")), "elementName", "valueSetUrl", null, "code1", "code3");
            fail();
        } catch (IllegalStateException e) {}
    }
    ...
    public void testCheckValueSetBindingCodeableConceptLenientValid2() {
        FHIRModelConfig.setProperty(FHIRModelConfig.PROPERTY_EXTENDED_CODEABLE_CONCEPT_VALIDATION, false);
        ValidationSupport.checkValueSetBinding(CodeableConcept.builder().text(net.sovrinhealth.fhir.model.type.String.of("text")).build(), "elementName", "valueSet", "system", "code");
        FHIRModelConfig.setProperty(FHIRModelConfig.PROPERTY_EXTENDED_CODEABLE_CONCEPT_VALIDATION, true);
    }
