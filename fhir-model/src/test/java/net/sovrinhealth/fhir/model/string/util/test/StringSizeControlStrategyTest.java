package net.sovrinhealth.fhir.model.string.util.test;
...
import net.sovrinhealth.fhir.model.string.util.StringSizeControlStrategyFactory;
import net.sovrinhealth.fhir.model.string.util.StringSizeControlStrategyFactory.Strategy;
...
public class StringSizeControlStrategyTest {
    ...
    public void testStringSizeControlStrategyFactory() throws FHIROperationException {
        ...
        net.sovrinhealth.fhir.model.string.util.strategy.StringSizeControlStrategy strategy = factory.getStrategy(Strategy.MAX_BYTES);
