...
package net.sovrinhealth.fhir.model.generator;

import static net.sovrinhealth.fhir.model.util.ModelSupport.isPrimitiveType;
import static net.sovrinhealth.fhir.model.util.XMLSupport.FHIR_NS_URI;
import static net.sovrinhealth.fhir.model.util.XMLSupport.createNonClosingStreamWriterDelegate;
import static net.sovrinhealth.fhir.model.util.XMLSupport.createStreamWriterDelegate;
import static net.sovrinhealth.fhir.model.util.XMLSupport.createTransformer;
...
import net.sovrinhealth.fhir.model.util.XMLSupport.StreamWriterDelegate;
