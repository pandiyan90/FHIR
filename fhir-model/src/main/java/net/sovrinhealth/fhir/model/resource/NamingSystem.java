...
import net.sovrinhealth.fhir.model.type.code.NamingSystemIdentifierType;
import net.sovrinhealth.fhir.model.type.code.NamingSystemType;
...
public class NamingSystem extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #responsible(net.sovrinhealth.fhir.model.type.String)
         */
