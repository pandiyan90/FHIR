...
import net.sovrinhealth.fhir.model.type.code.SubscriptionNotificationType;
...
public class SubscriptionStatus extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #eventsSinceSubscriptionStart(net.sovrinhealth.fhir.model.type.String)
         */
    ...
    public static class NotificationEvent extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #eventNumber(net.sovrinhealth.fhir.model.type.String)
             */
