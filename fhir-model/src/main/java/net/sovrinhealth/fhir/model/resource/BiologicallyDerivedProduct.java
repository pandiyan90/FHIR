...
import net.sovrinhealth.fhir.model.type.code.BiologicallyDerivedProductCategory;
import net.sovrinhealth.fhir.model.type.code.BiologicallyDerivedProductStatus;
import net.sovrinhealth.fhir.model.type.code.BiologicallyDerivedProductStorageScale;
...
public class BiologicallyDerivedProduct extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #quantity(net.sovrinhealth.fhir.model.type.Integer)
         */
