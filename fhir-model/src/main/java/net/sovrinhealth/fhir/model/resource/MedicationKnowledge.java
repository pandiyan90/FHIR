...
import net.sovrinhealth.fhir.model.type.code.MedicationKnowledgeStatus;
...
public class MedicationKnowledge extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #synonym(net.sovrinhealth.fhir.model.type.String)
         */
    ...
    public static class Ingredient extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #isActive(net.sovrinhealth.fhir.model.type.Boolean)
             */
    ...
    public static class AdministrationGuidelines extends BackboneElement {
        ...
        public static class Dosage extends BackboneElement {
            ...
            private final CodeableConcept type;
            @Required
            private final List<net.sovrinhealth.fhir.model.type.Dosage> dosage;
             ...
             */
            public List<net.sovrinhealth.fhir.model.type.Dosage> getDosage() {
                return dosage;
            }
            ...
            public void accept(java.lang.String elementName, int elementIndex, Visitor visitor) {
                if (visitor.preVisit(this)) {
                    ...
                    if (visitor.visit(elementName, elementIndex, this)) {
                        ...
                        accept(modifierExtension, "modifierExtension", visitor, Extension.class);
                        accept(type, "type", visitor);
                        accept(dosage, "dosage", visitor, net.sovrinhealth.fhir.model.type.Dosage.class);
                    }
                    visitor.visitEnd(elementName, elementIndex, this);
                    visitor.postVisit(this);
                }
            ...
            public static class Builder extends BackboneElement.Builder {
                private CodeableConcept type;
                private List<net.sovrinhealth.fhir.model.type.Dosage> dosage = new ArrayList<>();
                 ...
                 *     A reference to this Builder instance
                 */
                public Builder dosage(net.sovrinhealth.fhir.model.type.Dosage... dosage) {
                    for (net.sovrinhealth.fhir.model.type.Dosage value : dosage) {
                        this.dosage.add(value);
                    }
                    return this;
                }
                 ...
                 *     If the passed collection is null
                 */
                public Builder dosage(Collection<net.sovrinhealth.fhir.model.type.Dosage> dosage) {
                    this.dosage = new ArrayList<>(dosage);
                    return this;
                }
                ...
                protected void validate(Dosage dosage) {
                    ...
                    ValidationSupport.checkNonEmptyList(dosage.dosage, "dosage", net.sovrinhealth.fhir.model.type.Dosage.class);
    ...
    public static class Regulatory extends BackboneElement {
        ...
        public static class Substitution extends BackboneElement {
            ...
            public static class Builder extends BackboneElement.Builder {
                 ...
                 *     A reference to this Builder instance
                 * 
                 * @see #allowed(net.sovrinhealth.fhir.model.type.Boolean)
                 */
