...
import net.sovrinhealth.fhir.model.type.code.AppointmentStatus;
import net.sovrinhealth.fhir.model.type.code.BindingStrength;
import net.sovrinhealth.fhir.model.type.code.ParticipantRequired;
import net.sovrinhealth.fhir.model.type.code.ParticipationStatus;
...
public class Appointment extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #patientInstruction(net.sovrinhealth.fhir.model.type.String)
         */
