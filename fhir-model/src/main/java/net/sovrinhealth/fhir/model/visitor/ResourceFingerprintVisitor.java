...
package net.sovrinhealth.fhir.model.visitor;
...
public class ResourceFingerprintVisitor extends PathAwareVisitor {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int index, net.sovrinhealth.fhir.model.type.String value) {
        // Exclude meta.versionId from the fingerprint because it gets injected by the FHIR server.
        return includePath();
    }

    @Override
    public boolean visit(java.lang.String elementName, int index, net.sovrinhealth.fhir.model.type.Instant value) {
