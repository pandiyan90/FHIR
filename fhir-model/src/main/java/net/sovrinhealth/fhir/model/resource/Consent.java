...
import net.sovrinhealth.fhir.model.type.code.ConsentDataMeaning;
import net.sovrinhealth.fhir.model.type.code.ConsentProvisionType;
import net.sovrinhealth.fhir.model.type.code.ConsentState;
...
public class Consent extends DomainResource {
    ...
    public static class Verification extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #verified(net.sovrinhealth.fhir.model.type.Boolean)
             */
