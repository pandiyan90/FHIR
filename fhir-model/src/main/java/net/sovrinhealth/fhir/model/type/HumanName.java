...
import net.sovrinhealth.fhir.model.type.code.NameUse;
...
public class HumanName extends Element {
    ...
    public static class Builder extends Element.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #family(net.sovrinhealth.fhir.model.type.String)
         */
         ...
         *     A reference to this Builder instance
         * 
         * @see #given(net.sovrinhealth.fhir.model.type.String)
         */
         ...
         *     A reference to this Builder instance
         * 
         * @see #suffix(net.sovrinhealth.fhir.model.type.String)
         */
