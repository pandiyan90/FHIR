...
public final class XMLSupport {
    ...
    private static final String PROP_XML_INPUT_FACTORY_CONFIG = "net.sovrinhealth.fhir.xml.input.factory";
    private static final String PROP_XML_OUTPUT_FACTORY = "javax.xml.stream.XMLOutputFactory";
    private static final String PROP_XML_OUTPUT_FACTORY_CONFIG = "net.sovrinhealth.fhir.xml.output.factory";

    private static final String XML_INPUT_FACTORY_ID = "net.sovrinhealth.fhir.xml.input.factory";
    private static final String XML_INPUT_FACTORY_IMPL = "com.sun.xml.internal.stream.XMLInputFactoryImpl";
    private static final String XML_OUTPUT_FACTORY_ID = "net.sovrinhealth.fhir.xml.output.factory";
