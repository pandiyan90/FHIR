...
package net.sovrinhealth.fhir.model.config;
...
public final class FHIRModelConfig {
     ...
     */
    public static final String PROPERTY_TO_STRING_FORMAT = "net.sovrinhealth.fhir.model.toStringFormat";

    /**
     * The number of spaces to use when indenting (pretty printing must be enabled)
     */
    public static final String PROPERTY_TO_STRING_INDENT_AMOUNT = "net.sovrinhealth.fhir.model.toStringIndentAmount";

    /**
     * Used to determine whether the toString method return value should be formatted
     */
    public static final String PROPERTY_TO_STRING_PRETTY_PRINTING = "net.sovrinhealth.fhir.model.toStringPrettyPrinting";

    /**
     * Used to determine whether reference types are checked during object construction
     */
    public static final String PROPERTY_CHECK_REFERENCE_TYPES = "net.sovrinhealth.fhir.model.checkReferenceTypes";
     ...
     */
    public static final String PROPERTY_EXTENDED_CODEABLE_CONCEPT_VALIDATION = "net.sovrinhealth.fhir.model.extendedCodeableConceptValidation";

    /**
     * Used to determine whether control characters are checked
     */
    public static final String PROPERTY_CHECK_CONTROL_CHARS = "net.sovrinhealth.fhir.model.checkControlChars";
