...
import net.sovrinhealth.fhir.model.type.code.ResearchSubjectStatus;
...
public class ResearchSubject extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #assignedArm(net.sovrinhealth.fhir.model.type.String)
         */
         ...
         *     A reference to this Builder instance
         * 
         * @see #actualArm(net.sovrinhealth.fhir.model.type.String)
         */
