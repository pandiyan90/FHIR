...
import net.sovrinhealth.fhir.model.type.code.SortDirection;
...
public class DataRequirement extends Element {
    ...
    public static class Builder extends Element.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #mustSupport(net.sovrinhealth.fhir.model.type.String)
         */
    ...
    public static class CodeFilter extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #searchParam(net.sovrinhealth.fhir.model.type.String)
             */
