...
import net.sovrinhealth.fhir.model.type.code.MediaStatus;
...
public class Media extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #issued(net.sovrinhealth.fhir.model.type.Instant)
         */
         ...
         *     A reference to this Builder instance
         * 
         * @see #deviceName(net.sovrinhealth.fhir.model.type.String)
         */
