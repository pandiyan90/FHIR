...
import net.sovrinhealth.fhir.model.type.code.RiskAssessmentStatus;
...
public class RiskAssessment extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #mitigation(net.sovrinhealth.fhir.model.type.String)
         */
    ...
    public static class Prediction extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #rationale(net.sovrinhealth.fhir.model.type.String)
             */
