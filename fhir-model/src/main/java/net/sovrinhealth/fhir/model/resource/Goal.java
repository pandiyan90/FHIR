...
import net.sovrinhealth.fhir.model.type.code.GoalLifecycleStatus;
...
public class Goal extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #statusDate(net.sovrinhealth.fhir.model.type.Date)
         */
         ...
         *     A reference to this Builder instance
         * 
         * @see #statusReason(net.sovrinhealth.fhir.model.type.String)
         */
