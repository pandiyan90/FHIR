...
import net.sovrinhealth.fhir.model.type.code.EligibilityRequestPurpose;
import net.sovrinhealth.fhir.model.type.code.EligibilityRequestStatus;
...
public class CoverageEligibilityRequest extends DomainResource {
    ...
    public static class SupportingInfo extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #appliesToAll(net.sovrinhealth.fhir.model.type.Boolean)
             */
