...
import net.sovrinhealth.fhir.model.type.code.FamilyHistoryStatus;
...
public class FamilyMemberHistory extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #estimatedAge(net.sovrinhealth.fhir.model.type.Boolean)
         */
    ...
    public static class Condition extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #contributedToDeath(net.sovrinhealth.fhir.model.type.Boolean)
             */
