...
import net.sovrinhealth.fhir.model.type.code.DayOfWeek;
import net.sovrinhealth.fhir.model.type.code.EventTiming;
import net.sovrinhealth.fhir.model.type.code.UnitsOfTime;
...
public class Timing extends BackboneElement {
    ...
    public static class Repeat extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #timeOfDay(net.sovrinhealth.fhir.model.type.Time)
             */
