...
import net.sovrinhealth.fhir.model.type.code.InvoicePriceComponentType;
import net.sovrinhealth.fhir.model.type.code.InvoiceStatus;
...
public class Invoice extends DomainResource {
    ...
    public static class Builder extends DomainResource.Builder {
         ...
         *     A reference to this Builder instance
         * 
         * @see #cancelledReason(net.sovrinhealth.fhir.model.type.String)
         */
