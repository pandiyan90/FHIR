...
import net.sovrinhealth.fhir.model.type.code.DeviceMetricCalibrationState;
import net.sovrinhealth.fhir.model.type.code.DeviceMetricCalibrationType;
import net.sovrinhealth.fhir.model.type.code.DeviceMetricCategory;
import net.sovrinhealth.fhir.model.type.code.DeviceMetricColor;
import net.sovrinhealth.fhir.model.type.code.DeviceMetricOperationalStatus;
...
public class DeviceMetric extends DomainResource {
    ...
    public static class Calibration extends BackboneElement {
        ...
        public static class Builder extends BackboneElement.Builder {
             ...
             *     A reference to this Builder instance
             * 
             * @see #time(net.sovrinhealth.fhir.model.type.Instant)
             */
