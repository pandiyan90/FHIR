...
import net.sovrinhealth.fhir.model.resource.QuestionnaireResponse;
...
import net.sovrinhealth.fhir.model.visitor.AbstractVisitable;
...
public abstract class DataCreatorBase {
    ...
    private String resourcePackageName = "net.sovrinhealth.fhir.model.resource";
