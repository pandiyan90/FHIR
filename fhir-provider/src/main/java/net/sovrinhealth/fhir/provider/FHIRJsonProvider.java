...
package net.sovrinhealth.fhir.provider;

import static net.sovrinhealth.fhir.model.util.FHIRUtil.buildOperationOutcome;
import static net.sovrinhealth.fhir.model.util.FHIRUtil.buildOperationOutcomeIssue;
import static net.sovrinhealth.fhir.model.util.JsonSupport.nonClosingInputStream;
import static net.sovrinhealth.fhir.model.util.JsonSupport.nonClosingOutputStream;
import static net.sovrinhealth.fhir.provider.util.FHIRProviderUtil.buildResponse;
import static net.sovrinhealth.fhir.provider.util.FHIRProviderUtil.getMediaType;
