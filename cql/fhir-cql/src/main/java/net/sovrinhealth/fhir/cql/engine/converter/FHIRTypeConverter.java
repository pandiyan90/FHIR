 ...
 */
package net.sovrinhealth.fhir.cql.engine.converter;
...
public interface FHIRTypeConverter {
     ...
     */
    public net.sovrinhealth.fhir.model.type.Boolean toFhirBoolean(Boolean value);
     ...
     */
    public net.sovrinhealth.fhir.model.type.Integer toFhirInteger(Integer value);
     ...
     */
    public net.sovrinhealth.fhir.model.type.Decimal toFhirDecimal(BigDecimal value);
     ...
     * @return a FHIR Date
     */
    public net.sovrinhealth.fhir.model.type.Date toFhirDate(Date value);
     ...
     */
    public net.sovrinhealth.fhir.model.type.DateTime toFhirDateTime(DateTime value);
     ...
     * @return a FHIR Time
     */
    public net.sovrinhealth.fhir.model.type.Time toFhirTime(Time value);
     ...
     */
    public net.sovrinhealth.fhir.model.type.String toFhirString(String value);
     ...
     */
    public net.sovrinhealth.fhir.model.type.Quantity toFhirQuantity(Quantity value);
     ...
     * @return a FHIR Ratio
     */
    public net.sovrinhealth.fhir.model.type.Ratio toFhirRatio(Ratio value);
     ...
     * @return a FHIR Any
     */
    // public net.sovrinhealth.fhir.model.type. toFhirAny(Object value);
     ...
     */
    public net.sovrinhealth.fhir.model.type.CodeableConcept toFhirCodeableConcept(Concept value);
     ...
     */
    public net.sovrinhealth.fhir.model.type.Period toFhirPeriod(Interval value);
     ...
     * @return a FHIR Range
     */
    public net.sovrinhealth.fhir.model.type.Range toFhirRange(Interval value);
     ...
     */
    public net.sovrinhealth.fhir.model.type.Element toFhirInterval(Interval value);
     ...
     * @return a Boolean
     */
    public Boolean toCqlBoolean(net.sovrinhealth.fhir.model.type.Boolean value);
     ...
     * @return an Integer
     */
    public Integer toCqlInteger(net.sovrinhealth.fhir.model.type.Integer value);
     ...
     * @return a BigDecimal
     */
    public BigDecimal toCqlDecimal(net.sovrinhealth.fhir.model.type.Decimal value);
     ...
     */
    public Date toCqlDate(net.sovrinhealth.fhir.model.type.Date value);
     ...
     */
    public DateTime toCqlDateTime(net.sovrinhealth.fhir.model.type.DateTime value);
     ...
     */
    public BaseTemporal toCqlTemporal(net.sovrinhealth.fhir.model.type.Element value);
     ...
     */
    public Time toCqlTime(net.sovrinhealth.fhir.model.type.Time value);
     ...
     * @return a String
     */
    public String toCqlString(net.sovrinhealth.fhir.model.type.String value);
     ...
     */
    public Quantity toCqlQuantity(net.sovrinhealth.fhir.model.type.Quantity value);
     ...
     */
    public Ratio toCqlRatio(net.sovrinhealth.fhir.model.type.Ratio value);
     ...
     * @return a CQL Code
     */
    public Code toCqlCode(net.sovrinhealth.fhir.model.type.Coding value);
     ...
     */
    public Concept toCqlConcept(net.sovrinhealth.fhir.model.type.CodeableConcept value);
     ...
     */
    public Interval toCqlInterval(net.sovrinhealth.fhir.model.type.Element value);
