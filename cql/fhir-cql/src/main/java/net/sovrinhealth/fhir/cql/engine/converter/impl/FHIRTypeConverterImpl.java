 ...
 */
package net.sovrinhealth.fhir.cql.engine.converter.impl;
...
import static net.sovrinhealth.fhir.cql.helpers.ModelHelper.javastring;
...
import net.sovrinhealth.fhir.cql.engine.converter.FHIRTypeConverter;
import net.sovrinhealth.fhir.cql.helpers.DateHelper;
...
public class FHIRTypeConverterImpl implements FHIRTypeConverter {
    ...
    public net.sovrinhealth.fhir.model.type.Boolean toFhirBoolean(Boolean value) {
        net.sovrinhealth.fhir.model.type.Boolean result = null;
        if (value != null) {
            result = net.sovrinhealth.fhir.model.type.Boolean.of(value);
        }
        return result;
    }
    ...
    public Integer toFhirInteger(java.lang.Integer value) {
        net.sovrinhealth.fhir.model.type.Integer result = null;
        if (value != null) {
            result = net.sovrinhealth.fhir.model.type.Integer.of(value);
        }
        return result;
    }
    ...
    public net.sovrinhealth.fhir.model.type.String toFhirString(String value) {
        net.sovrinhealth.fhir.model.type.String result = null;
        if (value != null) {
            result = net.sovrinhealth.fhir.model.type.String.of(value);
        }
        return result;
    }
    ...
    public Object toCqlType(Object value) {
        ...
        case "Id":
            ...
            break;
        case "Boolean":
            result = toCqlBoolean((net.sovrinhealth.fhir.model.type.Boolean) value);
            break;
        case "Integer":
            result = toCqlInteger((net.sovrinhealth.fhir.model.type.Integer) value);
            break;
        case "Decimal":
            result = toCqlDecimal((net.sovrinhealth.fhir.model.type.Decimal) value);
            break;
        case "Date":
            result = toCqlDate((net.sovrinhealth.fhir.model.type.Date) value);
            break;
        // NOTE: There's no first class InstantType in CQL, so the conversation to CQL
        // DateTime and back is asymmetric
        case "Instant":
        case "DateTime":
            result = toCqlDateTime((net.sovrinhealth.fhir.model.type.DateTime) value);
            break;
        case "Time":
            result = toCqlTime((net.sovrinhealth.fhir.model.type.Time) value);
            break;
        case "String":
            result = toCqlString((net.sovrinhealth.fhir.model.type.String) value);
            break;
        case "Quantity":
            result = toCqlQuantity((net.sovrinhealth.fhir.model.type.Quantity) value);
            break;
        case "Ratio":
            result = toCqlRatio((net.sovrinhealth.fhir.model.type.Ratio) value);
            break;
        // case "AnyType": result = toCqlAny((IBase)value);break;
        case "Coding":
            result = toCqlCode((net.sovrinhealth.fhir.model.type.Coding) value);
            break;
        case "CodeableConcept":
            result = toCqlConcept((net.sovrinhealth.fhir.model.type.CodeableConcept) value);
            break;
        case "Period":
        case "Range":
            result = toCqlInterval((net.sovrinhealth.fhir.model.type.Element) value);
            break;
