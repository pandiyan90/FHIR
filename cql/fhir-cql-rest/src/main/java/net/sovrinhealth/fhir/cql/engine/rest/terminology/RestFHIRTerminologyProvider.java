...
public class RestFHIRTerminologyProvider implements TerminologyProvider {
    ...
    public boolean in(Code code, ValueSetInfo valueSet) {
        ...
        try {
            ...
            return ((net.sovrinhealth.fhir.model.type.Boolean) output.getValue()).getValue();
    ...
    public Code lookup(Code code, CodeSystemInfo codeSystem) {
        try {
            ...
            if (display != null) {
                code.withDisplay(((net.sovrinhealth.fhir.model.type.String) display.getValue()).getValue());
            }
                ...
                if (!searchResults.hasChildren() || searchResults.getEntry().isEmpty()) {
                    ...
                    if (id.matches("[A-Za-z0-9\\-\\.]{1,64}")) {
                        ...
                        if (response.getStatus() == 200) {
                            ...
                            searchResults =
                                    Bundle.builder().type(BundleType.SEARCHSET).total(net.sovrinhealth.fhir.model.type.UnsignedInt.of(1)).entry(Bundle.Entry.builder().id(vs.getId()).resource(vs).build()).build();
                        }
                    }
                }
            }
