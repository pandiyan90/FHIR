 ...
 */
package net.sovrinhealth.fhir.cql.engine.rest.terminology;

import static net.sovrinhealth.fhir.cql.engine.util.FHIRClientUtil.urlencode;
...
import net.sovrinhealth.fhir.cql.engine.rest.R4RestFHIRTest;
...
public class RestFHIRTerminologyProviderTest extends R4RestFHIRTest {
    ...
    public void resolveByUrlUsingIdentifierSucceeds() throws Exception {
        ...
        ValueSet response =
                ValueSet.builder().id("1.2.3.4").status(PublicationStatus.ACTIVE).identifier(Identifier.builder().value(net.sovrinhealth.fhir.model.type.String.of(info.getId())).build()).build();
    ...
    public void inOperationReturnsTrueWhenFhirReturnsTrue() throws Exception {
        ...
        Parameters parameters =
                Parameters.builder().parameter(Parameters.Parameter.builder().name(net.sovrinhealth.fhir.model.type.String.of("result")).value(net.sovrinhealth.fhir.model.type.Boolean.of(true)).build()).build();
    ...
    public void inOperationReturnsFalseWhenFhirReturnsFalse() throws Exception {
        ...
        Parameters parameters =
                Parameters.builder().parameter(Parameters.Parameter.builder().name(net.sovrinhealth.fhir.model.type.String.of("result")).value(net.sovrinhealth.fhir.model.type.Boolean.of(false)).build()).build();
    ...
    public void lookupOperationSuccess() throws Exception {
        ...
        Parameters parameters =
                Parameters.builder().parameter(Parameter.builder().name(net.sovrinhealth.fhir.model.type.Code.of("name")).value(net.sovrinhealth.fhir.model.type.String.of(code.getCode())).build()).parameter(Parameter.builder().name(net.sovrinhealth.fhir.model.type.Code.of("version")).value(code.getVersion() != null
                        ? net.sovrinhealth.fhir.model.type.String.of(code.getVersion())
                        : null).build()).parameter(Parameter.builder().name(net.sovrinhealth.fhir.model.type.Code.of("display")).value(code.getDisplay() != null
                                ? net.sovrinhealth.fhir.model.type.String.of(code.getDisplay()) : null).build()).build();
    ...
    private ValueSet getSingleCodeValueSet(String id, String system, String code) {
        ValueSet valueSet =
                ValueSet.builder().id(id).status(PublicationStatus.ACTIVE).expansion(Expansion.builder().timestamp(DateTime.now()).contains(Contains.builder().system(Uri.of(system)).code(net.sovrinhealth.fhir.model.type.Code.of(code)).build()).build()).build();
        return valueSet;
    }
}
