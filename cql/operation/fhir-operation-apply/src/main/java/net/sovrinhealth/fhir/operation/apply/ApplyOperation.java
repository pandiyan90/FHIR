...
package net.sovrinhealth.fhir.operation.apply;
...
import net.sovrinhealth.fhir.model.resource.CarePlan.Activity.Detail;
...
import net.sovrinhealth.fhir.model.type.Dosage.DoseAndRate;
...
import net.sovrinhealth.fhir.model.type.code.CarePlanActivityKind;
import net.sovrinhealth.fhir.model.type.code.CarePlanActivityStatus;
import net.sovrinhealth.fhir.model.type.code.CarePlanIntent;
...
public class ApplyOperation extends AbstractOperation {
    ...
    private CodeableConcept internalCheckAndProcess(FHIROperationContext operationContext,
        ...
        for (Parameter p : parameters.getParameter()) {
            if (p.getName() != null && p.getName().getValue().compareTo(parameter) == 0) {
                return p.getValue().as(net.sovrinhealth.fhir.model.type.CodeableConcept.class);
            }
        }
        return null;
    }
    ...
    private String internalCheckAndProcess(FHIRResourceHelpers resourceHelper,
        ...
        if (result == null) {
            for (Parameter p : parameters.getParameter()) {
                ...
                if (p.getName() != null && p.getName().getValue().compareTo(parameter) == 0) {
                    result = p.getValue().as(net.sovrinhealth.fhir.model.type.String.class).getValue();
                    break;
                }
            }
        }
    ...
    private CarePlan transform(PlanDefinition planDefinition, List<String> subjects,
        ...
        if (userTaskContext != null) {
            builder.description(userTaskContext.as(net.sovrinhealth.fhir.model.type.String.class));
        }
        ...
        if (userLanguage != null) {
            net.sovrinhealth.fhir.model.type.String lang = userLanguage.getText();
