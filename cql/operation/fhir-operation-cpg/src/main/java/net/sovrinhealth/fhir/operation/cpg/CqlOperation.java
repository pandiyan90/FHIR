...
import static net.sovrinhealth.fhir.cql.helpers.ModelHelper.relatedArtifact;
...
import net.sovrinhealth.fhir.cql.helpers.CqlBuilder;
...
public class CqlOperation extends AbstractCqlOperation {
    ...
    protected Library createLibraryResource(String context, Parameter expression, List<Parameter> includes) {
        ...
        content.expression(DEFAULT_DEFINE_NAME, ((net.sovrinhealth.fhir.model.type.String) expression.getValue()).getValue());
    ...
    protected IncludeLibraryDetail getIncludeDetail(Parameter includeParameter) {
        ...
        for (Parameter part : includeParameter.getPart()) {
            ...
            if (paramName.equals(PARAM_IN_LIBRARY_URL)) {
                ...
                includeDetail.alias = ((net.sovrinhealth.fhir.model.type.String) part.getValue()).getValue();
            } else {
