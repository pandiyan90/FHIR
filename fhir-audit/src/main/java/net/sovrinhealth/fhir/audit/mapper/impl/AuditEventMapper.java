 ...
 */
package net.sovrinhealth.fhir.audit.mapper.impl;

import static net.sovrinhealth.fhir.model.type.Code.code;
...
import net.sovrinhealth.fhir.audit.beans.FHIRContext;
import net.sovrinhealth.fhir.audit.mapper.Mapper;
...
import net.sovrinhealth.fhir.model.resource.AuditEvent.Agent;
import net.sovrinhealth.fhir.model.resource.AuditEvent.Agent.Network;
import net.sovrinhealth.fhir.model.resource.AuditEvent.Entity;
import net.sovrinhealth.fhir.model.resource.AuditEvent.Entity.Detail;
import net.sovrinhealth.fhir.model.resource.AuditEvent.Source;
...
import net.sovrinhealth.fhir.model.type.code.AuditEventAction;
import net.sovrinhealth.fhir.model.type.code.AuditEventAgentNetworkType;
...
public class AuditEventMapper implements Mapper {
    ...
    private static Map<String, net.sovrinhealth.fhir.model.type.code.AuditEventAction> buildMapToAction() {
        Map<String, net.sovrinhealth.fhir.model.type.code.AuditEventAction> map = new HashMap<>();
     ...
     */
    private net.sovrinhealth.fhir.model.type.Period period(AuditLogEntry entry) {
        // @formatter:off
        return net.sovrinhealth.fhir.model.type.Period.builder()
                .start(net.sovrinhealth.fhir.model.type.DateTime.of(
                    ZonedDateTime.of(Timestamp.valueOf(entry.getContext().getStartTime()).toLocalDateTime(), ZoneId.of("UTC"))
                    ))
                .end(net.sovrinhealth.fhir.model.type.DateTime.of(
    ...
    private List<Agent> agent(AuditLogEntry entry) {
        Agent collector = Agent.builder()
                .requestor(net.sovrinhealth.fhir.model.type.Boolean.TRUE)
     ...
     */
    private net.sovrinhealth.fhir.model.type.String outcomeDesc(AuditLogEntry entry) {
    ...
    private net.sovrinhealth.fhir.model.type.code.AuditEventOutcome outcome(AuditLogEntry entry) {
        if (entry.getContext().getApiParameters().getStatus() < 400) {
            return net.sovrinhealth.fhir.model.type.code.AuditEventOutcome.OUTCOME_0;
        } else if (entry.getContext().getApiParameters().getStatus() < 500) {
            return net.sovrinhealth.fhir.model.type.code.AuditEventOutcome.OUTCOME_4;
        } else {
            return net.sovrinhealth.fhir.model.type.code.AuditEventOutcome.OUTCOME_12;
        }
    }
}