...
import static net.sovrinhealth.fhir.audit.AuditLogServiceConstants.DEFAULT_AUDIT_GEO_CITY;
import static net.sovrinhealth.fhir.audit.AuditLogServiceConstants.DEFAULT_AUDIT_GEO_COUNTRY;
import static net.sovrinhealth.fhir.audit.AuditLogServiceConstants.DEFAULT_AUDIT_GEO_STATE;
import static net.sovrinhealth.fhir.audit.AuditLogServiceConstants.PROPERTY_AUDIT_GEO_CITY;
import static net.sovrinhealth.fhir.audit.AuditLogServiceConstants.PROPERTY_AUDIT_GEO_COUNTRY;
import static net.sovrinhealth.fhir.audit.AuditLogServiceConstants.PROPERTY_AUDIT_GEO_STATE;
...
import net.sovrinhealth.fhir.audit.cadf.CadfAttachment;
import net.sovrinhealth.fhir.audit.cadf.CadfCredential;
import net.sovrinhealth.fhir.audit.cadf.CadfEndpoint;
import net.sovrinhealth.fhir.audit.cadf.CadfEvent;
import net.sovrinhealth.fhir.audit.cadf.CadfGeolocation;
import net.sovrinhealth.fhir.audit.cadf.CadfResource;
import net.sovrinhealth.fhir.audit.cadf.enums.Action;
import net.sovrinhealth.fhir.audit.cadf.enums.EventType;
import net.sovrinhealth.fhir.audit.cadf.enums.Outcome;
import net.sovrinhealth.fhir.audit.cadf.enums.ResourceType;
