...
public class ConfigurationTest {
    ...
    public void testRemapping() {
        ...
        assertEquals(translator.remap("net.sovrinhealth.fhir.audit.logging.impl.DisabledAuditLogService"), "net.sovrinhealth.fhir.audit.impl.NopService");
        assertEquals(translator.remap("net.sovrinhealth.fhir.audit.logging.impl.WhcAuditCadfLogService"), "net.sovrinhealth.fhir.audit.impl.KafkaService");
    }
