...
package net.sovrinhealth.fhir.server.listener;

import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_CHECK_CONTROL_CHARS;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_CHECK_REFERENCE_TYPES;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_DATASOURCES;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_EXTENDED_CODEABLE_CONCEPT_VALIDATION;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_CONNECTIONPROPS;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_ENABLED;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_INDEX_SERVICE_CONNECTIONPROPS;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_INDEX_SERVICE_MODE;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_INDEX_SERVICE_TOPICNAME;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_KAFKA_TOPICNAME;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_CHANNEL;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_CLIENT;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_CLUSTER;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_ENABLED;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_KEYSTORE;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_KEYSTORE_PW;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_SERVERS;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_TLS_ENABLED;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_TRUSTSTORE;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_NATS_TRUSTSTORE_PW;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_REMOTE_INDEX_SERVICE_INSTANCEIDENTIFIER;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_REMOTE_INDEX_SERVICE_TYPE;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_SERVER_REGISTRY_RESOURCE_PROVIDER_ENABLED;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_SERVER_RESOLVE_FUNCTION_ENABLED;
import static net.sovrinhealth.fhir.config.FHIRConfiguration.PROPERTY_WEBSOCKET_ENABLED;
...
import net.sovrinhealth.fhir.config.CallTimeMetric;
...
import net.sovrinhealth.fhir.database.utils.derby.DerbyServerPropertiesMgr;
...
import net.sovrinhealth.fhir.model.lang.util.LanguageRegistryUtil;
...
import net.sovrinhealth.fhir.server.index.kafka.FHIRRemoteIndexKafkaService;
import net.sovrinhealth.fhir.server.index.kafka.KafkaPropertyAdapter;
import net.sovrinhealth.fhir.server.notification.kafka.FHIRNotificationKafkaPublisher;
import net.sovrinhealth.fhir.server.notification.websocket.FHIRNotificationServiceEndpointConfig;
import net.sovrinhealth.fhir.server.notifications.nats.FHIRNotificationNATSPublisher;
...
import net.sovrinhealth.fhir.server.resolve.ServerResolveFunction;
import net.sovrinhealth.fhir.server.spi.operation.FHIROperationUtil;
import net.sovrinhealth.fhir.term.config.FHIRTermConfig;
import net.sovrinhealth.fhir.term.graph.provider.GraphTermServiceProvider;
import net.sovrinhealth.fhir.term.remote.provider.RemoteTermServiceProvider;
import net.sovrinhealth.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration;
import net.sovrinhealth.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration.BasicAuth;
import net.sovrinhealth.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration.Header;
import net.sovrinhealth.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration.Supports;
import net.sovrinhealth.fhir.term.remote.provider.RemoteTermServiceProvider.Configuration.TrustStore;
...
public class FHIRServletContextListener implements ServletContextListener {
    ...
    private static final Logger metricLogger = Logger.getLogger("net.sovrinhealth.fhir.MetricReport");
    ...
    public static final String FHIR_SERVER_INIT_COMPLETE = "net.sovrinhealth.fhir.webappInitComplete";
