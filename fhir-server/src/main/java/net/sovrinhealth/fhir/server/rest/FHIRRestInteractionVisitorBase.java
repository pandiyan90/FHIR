...
public abstract class FHIRRestInteractionVisitorBase implements FHIRRestInteractionVisitor {
    ...
    protected static final net.sovrinhealth.fhir.model.type.String SC_BAD_REQUEST_STRING = string(Integer.toString(SC_BAD_REQUEST));
    protected static final net.sovrinhealth.fhir.model.type.String SC_GONE_STRING = string(Integer.toString(SC_GONE));
    protected static final net.sovrinhealth.fhir.model.type.String SC_NOT_FOUND_STRING = string(Integer.toString(SC_NOT_FOUND));
    protected static final net.sovrinhealth.fhir.model.type.String SC_ACCEPTED_STRING = string(Integer.toString(SC_ACCEPTED));
    protected static final net.sovrinhealth.fhir.model.type.String SC_OK_STRING = string(Integer.toString(SC_OK));
    protected static final net.sovrinhealth.fhir.model.type.String SC_PRECONDITION_FAILED_STRING = string(Integer.toString(SC_PRECONDITION_FAILED));
