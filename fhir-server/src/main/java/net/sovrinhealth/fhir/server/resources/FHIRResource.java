...
import static net.sovrinhealth.fhir.server.util.FHIRRestSupport.getEtagValueFromLocation;
...
public class FHIRResource {
     ...
     *
     * @return the corresponding FHIRVersion for the net.sovrinhealth.fhir.server.fhirVersion request context attribute
     */
