...
public class MockRegistryResourceProvider implements FHIRRegistryResourceProvider {
    StructureDefinition profile1sd = StructureDefinition.builder()
            .url(Uri.of("profile1"))
            .name(net.sovrinhealth.fhir.model.type.String.of("profile1"))
            .status(PublicationStatus.ACTIVE)
            .kind(StructureDefinitionKind.RESOURCE)
            ._abstract(net.sovrinhealth.fhir.model.type.Boolean.FALSE)
            .type(Uri.of("Patient"))
    ...
    StructureDefinition profile2sd = StructureDefinition.builder()
            .url(Uri.of("profile2"))
            .name(net.sovrinhealth.fhir.model.type.String.of("profile2"))
            .status(PublicationStatus.ACTIVE)
            .kind(StructureDefinitionKind.RESOURCE)
            ._abstract(net.sovrinhealth.fhir.model.type.Boolean.FALSE)
            .type(Uri.of("Patient"))
    ...
    StructureDefinition profile3sd = StructureDefinition.builder()
            .url(Uri.of("profile3"))
            .name(net.sovrinhealth.fhir.model.type.String.of("profile3"))
            .status(PublicationStatus.ACTIVE)
            .kind(StructureDefinitionKind.RESOURCE)
            ._abstract(net.sovrinhealth.fhir.model.type.Boolean.FALSE)
            .type(Uri.of("Patient"))
    ...
    StructureDefinition profile4sd = StructureDefinition.builder()
            .url(Uri.of("profile4"))
            .name(net.sovrinhealth.fhir.model.type.String.of("profile4"))
            .status(PublicationStatus.ACTIVE)
            .kind(StructureDefinitionKind.RESOURCE)
            ._abstract(net.sovrinhealth.fhir.model.type.Boolean.FALSE)
    ...
    StructureDefinition profile5sd = StructureDefinition.builder()
            .url(Uri.of("profile5"))
            .name(net.sovrinhealth.fhir.model.type.String.of("profile5"))
            .status(PublicationStatus.ACTIVE)
            .kind(StructureDefinitionKind.RESOURCE)
            ._abstract(net.sovrinhealth.fhir.model.type.Boolean.FALSE)
            .type(Uri.of("Patient"))
