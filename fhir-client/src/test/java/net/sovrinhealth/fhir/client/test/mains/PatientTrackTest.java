...
//     private static final String PATIENT_TESTDATA = "patientNoDiv.json";
    ...
    private static final String EXTURI_FAVORITE_NFL = "http://net.sovrinhealth.fhir.sample/favorite-nfl";
    private static final String EXTURI_FAVORITE_NBA = "http://net.sovrinhealth.fhir.sample/favorite-nba";
