...
public class FHIRParameters {
     ...
     * @implNote please keep in sync with {@link net.sovrinhealth.fhir.search.SearchConstants.Modifier}
     */
     ...
     * @implNote please keep in sync with {@link net.sovrinhealth.fhir.search.SearchConstants.Prefix}
     */
