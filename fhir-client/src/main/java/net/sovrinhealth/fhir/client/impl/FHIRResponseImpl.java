...
package net.sovrinhealth.fhir.client.impl;
...
public class FHIRResponseImpl implements FHIRResponse {
    ...
    /* (non-Javadoc)
     * @see net.sovrinhealth.fhir.client.FHIRResponse#getStatusCode()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.sovrinhealth.fhir.client.FHIRResponse#getLocationURI()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.sovrinhealth.fhir.client.FHIRResponse#getLocation()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.sovrinhealth.fhir.client.FHIRResponse#getLastModified()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.sovrinhealth.fhir.client.FHIRResponse#getETag()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.sovrinhealth.fhir.client.FHIRResponse#getResource(java.lang.Class)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.sovrinhealth.fhir.client.FHIRResponse#getResponse()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.sovrinhealth.fhir.client.FHIRResponse#parseLocation()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see net.sovrinhealth.fhir.client.FHIRResponse#isEmpty()
     */
    @Override
