    ...
    private static Parameter parseParameter(String typeName, String paramName, String value) throws FHIROperationException {
        ...
        try {
            if ("boolean".equals(typeName)) {
                parameterBuilder.value(net.sovrinhealth.fhir.model.type.Boolean.of(value));
            } else if ("integer".equals(typeName)) {
                parameterBuilder.value(net.sovrinhealth.fhir.model.type.Integer.of(value));
            } else if ("string".equals(typeName)) {
                parameterBuilder.value(net.sovrinhealth.fhir.model.type.String.of(value));
            } else if ("decimal".equals(typeName)) {
                parameterBuilder.value(net.sovrinhealth.fhir.model.type.Decimal.of(value));
