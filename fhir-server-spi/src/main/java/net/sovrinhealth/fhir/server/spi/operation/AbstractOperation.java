                    ...
                    if (inputParameter.getPart() == null || inputParameter.getPart().isEmpty()) {
                        ...
                        try {
                            ...
                            if (ModelSupport.isResourceType(parameterDefinitionTypeName)) {
                                parameterDefinitionType = Class.forName("net.sovrinhealth.fhir.model.resource." + parameterDefinitionTypeName);
                            } else {
                                parameterDefinitionType = Class.forName("net.sovrinhealth.fhir.model.type." + parameterDefinitionTypeName);
                            }
