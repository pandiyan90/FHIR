...
package net.sovrinhealth.fhir.persistence.scale.test;
...
import net.sovrinhealth.fhir.persistence.cos.client.COSConfigAdapter;
import net.sovrinhealth.fhir.persistence.cos.client.COSPropertiesAdapter;
