...
package net.sovrinhealth.fhir.benchmark.runner;
...
public class FHIRBenchmarkRunner {
    public static final String PROPERTY_EXAMPLE_NAME = "net.sovrinhealth.fhir.benchmark.exampleName";
    public static final String PROPERTY_EXPRESSION = "net.sovrinhealth.fhir.benchmark.expression";
