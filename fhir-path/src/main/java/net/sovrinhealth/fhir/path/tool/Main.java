...
package net.sovrinhealth.fhir.path.tool;
...
public final class Main {
    ...
    private static class OutputPrinter implements FHIRPathNodeVisitor {
         ...
         * via the {@link net.sovrinhealth.fhir.model.resource.Resource} toString() implementation.
         */
        @Override
         ...
         * via the {@link net.sovrinhealth.fhir.model.type.Element} toString() implementation.
         */
        @Override
