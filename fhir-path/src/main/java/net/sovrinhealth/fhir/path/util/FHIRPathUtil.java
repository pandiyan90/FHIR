...
import net.sovrinhealth.fhir.path.FHIRPathNumberValue;
...
public final class FHIRPathUtil {
     ...
     */
    public static net.sovrinhealth.fhir.model.type.String getVersion(FHIRPathTree tree, FHIRPathElementNode elementNode) {
        if (tree != null) {
     ...
     */
    public static net.sovrinhealth.fhir.model.type.String getDisplay(FHIRPathTree tree, FHIRPathElementNode elementNode) {
        if (tree != null) {
