    ...
    private static void addOperation(Builder builder, Parameter operation) {
        ...
        for (Parameter part : operation.getPart()) {
            ...
            case FHIRPathPatchOperation.PATH:
                fhirPath = validatePartAndGetValue(foundPath, part, net.sovrinhealth.fhir.model.type.String.class).getValue();
                foundPath = true;
                break;
            case FHIRPathPatchOperation.NAME:
                name = validatePartAndGetValue(foundName, part, net.sovrinhealth.fhir.model.type.String.class).getValue();
                foundName = true;
                break;
            ...
            case FHIRPathPatchOperation.INDEX:
                index = validatePartAndGetValue(foundIndex, part, net.sovrinhealth.fhir.model.type.Integer.class).getValue();
                foundIndex = true;
                break;
            case FHIRPathPatchOperation.SOURCE:
                source = validatePartAndGetValue(foundSource, part, net.sovrinhealth.fhir.model.type.Integer.class).getValue();
                foundSource = true;
                break;
            case FHIRPathPatchOperation.DESTINATION:
                destination = validatePartAndGetValue(foundDestination, part, net.sovrinhealth.fhir.model.type.Integer.class).getValue();
