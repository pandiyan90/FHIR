...
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.isCodedElementNode;
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.isQuantityNode;
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.isStringElementNode;
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.isStringValue;
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.isUriElementNode;
...
import net.sovrinhealth.fhir.model.resource.ValueSet.Compose;
...
public class MemberOfFunction extends FHIRPathAbstractFunction {
            ...
            if (isExpanded(valueSet) || service.isExpandable(valueSet)) {
                try {
                    ...
                    if (element.is(Code.class)) {
                        ...
                        net.sovrinhealth.fhir.model.type.String version = getVersion(tree, elementNode);
                        Code code = element.as(Code.class);
                        net.sovrinhealth.fhir.model.type.String display = getDisplay(tree, elementNode);
    ...
    private boolean validateCode(FHIRTermService service, ValueSet valueSet, Uri system, net.sovrinhealth.fhir.model.type.String version, Code code, net.sovrinhealth.fhir.model.type.String display, EvaluationContext evaluationContext, FHIRPathElementNode elementNode, String strength) {
    ...
    private boolean convertsToCodeSystemValidateCode(ValueSet valueSet, Uri system, net.sovrinhealth.fhir.model.type.String version, Code code) {
    ...
    private boolean hasCodeSystem(ValueSet valueSet, Uri system, net.sovrinhealth.fhir.model.type.String version) {
    ...
    private CodeSystem getCodeSystem(ValueSet valueSet, Uri system, net.sovrinhealth.fhir.model.type.String version) {
        Compose compose = valueSet.getCompose();
        for (Include include : compose.getInclude()) {
