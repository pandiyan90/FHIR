...
public class MemberOfFunctionTest {
    ...
    public void testMemberOfFunction29() throws Exception {
        FHIRPathEvaluator evaluator = FHIRPathEvaluator.evaluator();
        Collection<FHIRPathNode> result = evaluator.evaluate(net.sovrinhealth.fhir.model.type.String.of(ENGLISH_US), "$this.memberOf('" + MemberOfFunction.ALL_LANG_VALUE_SET_URL + "')");
        Assert.assertEquals(result, SINGLETON_TRUE);
    }
    ...
    public void testMemberOfFunction30() throws Exception {
        FHIRPathEvaluator evaluator = FHIRPathEvaluator.evaluator();
        Collection<FHIRPathNode> result = evaluator.evaluate(net.sovrinhealth.fhir.model.type.String.of("invalidLanguageCode"), "$this.memberOf('" + MemberOfFunction.ALL_LANG_VALUE_SET_URL + "')");
        Assert.assertEquals(result, SINGLETON_FALSE);
    }
    ...
    public void testMemberOfFunction42() throws Exception {
        FHIRPathEvaluator evaluator = FHIRPathEvaluator.evaluator();
        Collection<FHIRPathNode> result = evaluator.evaluate(net.sovrinhealth.fhir.model.type.String.of(UNITS_PER_LITER), "$this.memberOf('" + MemberOfFunction.UCUM_UNITS_VALUE_SET_URL + "')");
        Assert.assertEquals(result, SINGLETON_TRUE);
    }
    ...
    public void testMemberOfFunction43() throws Exception {
        FHIRPathEvaluator evaluator = FHIRPathEvaluator.evaluator();
        Collection<FHIRPathNode> result = evaluator.evaluate(net.sovrinhealth.fhir.model.type.String.of("invalid ucum code"), "$this.memberOf('" + MemberOfFunction.UCUM_UNITS_VALUE_SET_URL + "')");
        Assert.assertEquals(result, SINGLETON_FALSE);
    }
    ...
    public void testMemberOfFunction49() throws Exception {
        ...
        net.sovrinhealth.fhir.model.type.String unknownString = net.sovrinhealth.fhir.model.type.String.builder()
    ...
    public void testMemberOfFunction50() throws Exception {
        ...
        net.sovrinhealth.fhir.model.type.String unknownStringWithVal = net.sovrinhealth.fhir.model.type.String.builder()
                .value("x")
                .extension(Extension.builder()
                    .url("http://hl7.org/fhir/StructureDefinition/data-absent-reason")
                    .value(Code.of("unknown"))
