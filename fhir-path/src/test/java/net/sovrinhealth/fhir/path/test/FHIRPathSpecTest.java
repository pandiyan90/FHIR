...
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.getBooleanValue;
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.getDate;
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.getDateTime;
...
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.getTime;
...
import net.sovrinhealth.fhir.model.util.XMLSupport;
