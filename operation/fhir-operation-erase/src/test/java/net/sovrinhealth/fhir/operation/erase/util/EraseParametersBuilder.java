 ...
 */
package net.sovrinhealth.fhir.operation.erase.util;
...
public final class EraseParametersBuilder {
    ...
    public EraseParametersBuilder badReason() {
        parameters.add(Parameter.builder().name(string(REASON)).value(net.sovrinhealth.fhir.model.type.Integer.of("1")).build());
        return this;
    }
    ...
    public EraseParametersBuilder absentReason() {
        net.sovrinhealth.fhir.model.type.String str = net.sovrinhealth.fhir.model.type.String.builder().extension(DATA_ABSENT).build();
    ...
    public EraseParametersBuilder badPatient() {
        parameters.add(Parameter.builder().name(string(PATIENT)).value(net.sovrinhealth.fhir.model.type.Integer.of("1")).build());
        return this;
    }
    ...
    public EraseParametersBuilder version(Integer version) {
        parameters.add(Parameter.builder().name(string(VERSION)).value(net.sovrinhealth.fhir.model.type.Integer.of(version)).build());
        return this;
    }
    ...
    public EraseParametersBuilder absentVersion() {
        net.sovrinhealth.fhir.model.type.Integer itr = net.sovrinhealth.fhir.model.type.Integer.builder().extension(DATA_ABSENT).build();
    ...
    public EraseParametersBuilder badId() {
        parameters.add(Parameter.builder().name(string(ID)).value(net.sovrinhealth.fhir.model.type.Integer.of("1")).build());
        return this;
    }
