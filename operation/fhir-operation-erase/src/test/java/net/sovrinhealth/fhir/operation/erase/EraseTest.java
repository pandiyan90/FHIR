...
import net.sovrinhealth.fhir.operation.erase.impl.EraseRestImpl;
import net.sovrinhealth.fhir.operation.erase.mock.MockAuditLogService;
import net.sovrinhealth.fhir.operation.erase.mock.MockFHIRResourceHelpers;
import net.sovrinhealth.fhir.operation.erase.mock.MockHttpServletRequest;
import net.sovrinhealth.fhir.operation.erase.mock.MockSecurityContext;
import net.sovrinhealth.fhir.operation.erase.util.EraseParametersBuilder;
...
public class EraseTest {
    ...
    @Test(expectedExceptions = {net.sovrinhealth.fhir.exception.FHIROperationException.class})
