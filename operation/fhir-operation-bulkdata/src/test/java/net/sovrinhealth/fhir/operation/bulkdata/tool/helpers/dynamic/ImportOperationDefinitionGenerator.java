...
import net.sovrinhealth.fhir.model.resource.OperationDefinition.Parameter;
...
public class ImportOperationDefinitionGenerator {
    ...
    public static void main(String[] args) {
        ...
        builder.id("import")
                ...
                .code(Code.of("import"))
                .system(net.sovrinhealth.fhir.model.type.Boolean.TRUE)
                .type(net.sovrinhealth.fhir.model.type.Boolean.FALSE)
                .instance(net.sovrinhealth.fhir.model.type.Boolean.FALSE)
                .contact(contact);
        ...
        opBuilder.min(net.sovrinhealth.fhir.model.type.Integer.of(1));
        ...
        OperationDefinition.Parameter part1 =
                OperationDefinition.Parameter.builder()
                        .name(Code.code("type"))
                        .min(net.sovrinhealth.fhir.model.type.Integer.of(1))
                        .max(string("1"))
        ...
        OperationDefinition.Parameter part4 =
                OperationDefinition.Parameter.builder()
                        ...
                        .min(net.sovrinhealth.fhir.model.type.Integer.of(0))
                        .max(string("*"))
