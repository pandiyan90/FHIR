...
import net.sovrinhealth.fhir.model.resource.Medication;
...
import net.sovrinhealth.fhir.server.spi.operation.FHIROperationContext.Type;
...
public class BulkDataExportUtilTest {
    ...
    public void testGetOutputParametersWithJson() throws Exception {
        ...
        assertFalse(result.getParameter().get(0).getValue().as(net.sovrinhealth.fhir.model.type.String.class).getValue().isEmpty());
    }
