...
To print the schema DDL for review, execute `net.sovrinhealth.fhir.schema.app.SchemaPrinter`:

``` shell
java -cp ./fhir-persistence-schema-${VERSION}-cli.jar net.sovrinhealth.fhir.schema.app.SchemaPrinter [--to-file]
```
