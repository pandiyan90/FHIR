...
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.CODE;
...
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.COMPOSITE_ID;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.CURRENT_ALLERGIES_LIST;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.CURRENT_DRUG_ALLERGIES_LIST;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.CURRENT_MEDICATIONS_LIST;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.CURRENT_PROBLEMS_LIST;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.CURRENT_RESOURCE_ID;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.DATA;
...
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.ITEM_LOGICAL_ID;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.LAST_UPDATED;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.LATITUDE_VALUE;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.LIST_LOGICAL_RESOURCES;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.LIST_LOGICAL_RESOURCE_ITEMS;
...
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.LONGITUDE_VALUE;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.MAX_SEARCH_STRING_BYTES;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.NUMBER_VALUE;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.NUMBER_VALUE_HIGH;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.NUMBER_VALUE_LOW;
...
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.PATIENT_CURRENT_REFS;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.PATIENT_LOGICAL_RESOURCES;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.PK;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.PROFILES;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.QUANTITY_VALUE;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.QUANTITY_VALUE_HIGH;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.QUANTITY_VALUE_LOW;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.REF_LOGICAL_RESOURCE_ID;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.REF_VALUES;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.REF_VALUES_V;
...
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.RESOURCE_PAYLOAD_KEY;
...
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.SECURITY;
...
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.TAGS;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.TOKEN_VALUES_V;
import static net.sovrinhealth.fhir.schema.control.FhirSchemaConstants.UUID_LEN;
...
import net.sovrinhealth.fhir.database.utils.common.DropPrimaryKey;
import net.sovrinhealth.fhir.database.utils.common.DropTable;
import net.sovrinhealth.fhir.database.utils.common.DropView;
...
import net.sovrinhealth.fhir.database.utils.model.View;
