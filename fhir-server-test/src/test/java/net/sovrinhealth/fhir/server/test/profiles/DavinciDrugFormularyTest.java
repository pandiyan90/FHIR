...
import net.sovrinhealth.fhir.model.resource.MedicationKnowledge;
...
public class DavinciDrugFormularyTest extends ProfilesTestBase {
    ...
    public void loadCoveragePlan1() throws Exception {
        ...
        net.sovrinhealth.fhir.model.resource.List list = FHIRParser.parser(Format.JSON).parse(inputStream);
        Entity<net.sovrinhealth.fhir.model.resource.List> entity = Entity.entity(list, FHIRMediaType.APPLICATION_FHIR_JSON);
    ...
    public void testFindAllCoveragePlans() throws Exception {
        if (!skip) {
            ...
            FHIRResponse response = client.search(net.sovrinhealth.fhir.model.resource.List.class.getSimpleName(), parameters);
    ...
    public void testFindAllFormularyDrugsInACoveragePlan() throws Exception {
        if (!skip) {
            ...
            FHIRResponse response = client.search(net.sovrinhealth.fhir.model.resource.MedicationKnowledge.class.getSimpleName(), parameters);
            assertSearchResponse(response, Response.Status.OK.getStatusCode());
            Bundle bundle = response.getResource(Bundle.class);
            assertNotNull(bundle);
            assertTrue(bundle.getEntry().size() >= 1);
