...
import net.sovrinhealth.fhir.audit.configuration.ConfigurationTranslator;
...
public class BundleTest extends FHIRServerTestBase {
    ...
    public void testBatchUpdates() throws Exception {
        ...
        patientB2 = patientB2.toBuilder().active(net.sovrinhealth.fhir.model.type.Boolean.TRUE).build();
        patientB1 = patientB1.toBuilder().active(net.sovrinhealth.fhir.model.type.Boolean.FALSE).build();
    ...
    public void testBatchUpdatesVersionAwareError1() throws Exception {
        ...
        // Make a small change to each patient.
        patientVA2 = patientVA2.toBuilder().active(net.sovrinhealth.fhir.model.type.Boolean.TRUE).build();
        patientVA1 = patientVA1.toBuilder().active(net.sovrinhealth.fhir.model.type.Boolean.FALSE).build();
