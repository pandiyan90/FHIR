...
import static net.sovrinhealth.fhir.model.type.String.of;
...
import net.sovrinhealth.fhir.model.resource.NutritionOrder;
...
import net.sovrinhealth.fhir.model.resource.Procedure.Performer;
...
import net.sovrinhealth.fhir.model.type.code.LinkType;
...
public class SearchRevIncludeTest extends FHIRServerTestBase {
    ...
    public void testCreateLibrary() throws Exception {
        ...
        library = library.toBuilder()
                ...
                .version(net.sovrinhealth.fhir.model.type.String.string("1.0"))
                .name(of(tag))
                .build();
