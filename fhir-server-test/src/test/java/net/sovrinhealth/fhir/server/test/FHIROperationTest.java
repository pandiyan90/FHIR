...
import net.sovrinhealth.fhir.model.resource.Composition.Section;
...
public class FHIROperationTest extends FHIRServerTestBase {
    ...
    public void testPostHelloOperation() throws Exception {
        ...
        assertEquals(((net.sovrinhealth.fhir.model.type.String) output.getParameter().get(0).getValue()).getValue(),
                message);
    }
