...
import net.sovrinhealth.fhir.server.test.websocket.FHIRNotificationServiceClientEndpoint;
...
public abstract class FHIRServerTestBase {
    ...
    protected boolean isComparmentSearchSupported() throws Exception {
        ...
        for (Extension e : conf.getExtension()) {
            if (e.getUrl().contains("persistenceType") && (((net.sovrinhealth.fhir.model.type.String) e.getValue())
                    .getValue().contains("FHIRPersistenceJDBCImpl")
                    || ((net.sovrinhealth.fhir.model.type.String) e.getValue()).getValue()
        ...
        if (restList != null) {
            ...
            if (rest != null) {
                ...
                if (rest.getInteraction() != null) {
                    for (net.sovrinhealth.fhir.model.resource.CapabilityStatement.Rest.Interaction interaction : rest.getInteraction()) {
