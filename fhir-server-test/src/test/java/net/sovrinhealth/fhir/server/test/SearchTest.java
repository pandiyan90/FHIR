...
import net.sovrinhealth.fhir.model.resource.Person.Link;
import net.sovrinhealth.fhir.model.resource.Practitioner;
import net.sovrinhealth.fhir.model.resource.PractitionerRole;
...
public class SearchTest extends FHIRServerTestBase {
    ...
    public void testCreateOrganization() throws Exception {
        ...
        organization = organization.toBuilder().name(net.sovrinhealth.fhir.model.type.String.of("test")).build();
    ...
    public void testCreatePatient() throws Exception {
        ...
        patient = patient.toBuilder()
                ...
                .managingOrganization(Reference.builder()
                    .reference(net.sovrinhealth.fhir.model.type.String.of("Organization/" + organizationId + "/_history/1"))
                    .build())
                .build();
    ...
    public void testCreatePractitionerRole() throws Exception {
        ...
        practitionerRole = practitionerRole.toBuilder()
                .organization(Reference.builder()
                    .reference(net.sovrinhealth.fhir.model.type.String.of("Organization/" + organizationId + "/_history/2"))
                    .build())
                .build();
