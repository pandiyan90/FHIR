...
public class SearchChainTest extends FHIRServerTestBase {
    ...
    public void testCreateProcedure() throws Exception {
        ...
        Reference reference = Reference.builder()
                .reference(net.sovrinhealth.fhir.model.type.String.of("Patient/" + patientId)).build();
    ...
    public void testCreateEncounter() throws Exception {
        ...
        Reference reference = Reference.builder()
                .reference(net.sovrinhealth.fhir.model.type.String.of("Patient/" + patientId + "/_history/2")).build();
