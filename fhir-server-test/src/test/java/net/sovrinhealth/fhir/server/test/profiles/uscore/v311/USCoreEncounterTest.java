    ...
    public void loadResources() throws Exception {
        ...
        CodeableConcept type = CodeableConcept.builder()
                .coding(Coding.builder()
                    .code(Code.of("DL"))
                    .display(net.sovrinhealth.fhir.model.type.String.of("Driver's license number"))
        ...
        Identifier identifier =
                Identifier.builder().system(Uri.of("urn:oid:0.1.2.3.4.5.6.7")).use(IdentifierUse.OFFICIAL).value(net.sovrinhealth.fhir.model.type.String.of("654321")).type(type).build();
