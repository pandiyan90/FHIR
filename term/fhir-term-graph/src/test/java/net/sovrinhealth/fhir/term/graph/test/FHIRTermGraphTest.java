...
public class FHIRTermGraphTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        g.V(v4).property("valueInteger", toObject(net.sovrinhealth.fhir.model.type.Integer.of(0))).next();
        ...
        System.out.println(g.V().has("valueInteger", toObject(net.sovrinhealth.fhir.model.type.Integer.of(-0))).hasNext());
