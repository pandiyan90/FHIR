...
import net.sovrinhealth.fhir.model.resource.Resource.Builder;
...
public class FHIRPersistenceUtil {
     ...
     * @return
     */
    public static net.sovrinhealth.fhir.model.type.Instant getUpdateTime() {
    ...
    public static <T extends Resource> T copyAndSetResourceMetaFields(T resource, String logicalId, int newVersionNumber, net.sovrinhealth.fhir.model.type.Instant lastUpdated) {
