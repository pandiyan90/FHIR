...
package net.sovrinhealth.fhir.persistence.test.common;
...
public abstract class AbstractReverseChainTest extends AbstractPersistenceTest {
    ...
    public void createResources() throws Exception {
        ...
        savedOrg1 = organization.toBuilder().active(net.sovrinhealth.fhir.model.type.Boolean.of(true)).build();
        savedOrg1 = FHIRPersistenceTestSupport.create(persistence, getDefaultPersistenceContext(), savedOrg1).getResource();
        savedOrg2 = organization.toBuilder().active(net.sovrinhealth.fhir.model.type.Boolean.of(true)).name(net.sovrinhealth.fhir.model.type.String.of("org2")).build();
        ...
        savedOrg3 = savedOrg3.toBuilder().name(net.sovrinhealth.fhir.model.type.String.of("org3")).build();
        ...
        savedObservation4 = observation.toBuilder()
                                       ...
                                       .encounter(reference("Encounter/" + savedEncounter1.getId()))
                                       .value(net.sovrinhealth.fhir.model.type.String.of("test"))
