...
import net.sovrinhealth.fhir.model.resource.Device.UdiCarrier;
...
import net.sovrinhealth.fhir.model.type.code.IssueType.Value;
...
public abstract class AbstractDeleteTest extends AbstractPersistenceTest {
    ...
    public void testUpdateDeletedDevice() throws Exception {
        ...
        final net.sovrinhealth.fhir.model.type.Instant lastUpdated = net.sovrinhealth.fhir.model.type.Instant.now(ZoneOffset.UTC);
