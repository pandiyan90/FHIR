...
package net.sovrinhealth.fhir.ig.carin.bb.test.tool;
...
public class LiveCapabilitiesToConfigGeneratorMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        CapabilityStatement statement = FHIRParser.parser(Format.JSON).parse(main.readMetadata()).as(net.sovrinhealth.fhir.model.resource.CapabilityStatement.class);
