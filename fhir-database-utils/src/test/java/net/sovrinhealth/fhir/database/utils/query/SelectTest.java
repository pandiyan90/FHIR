...
import static net.sovrinhealth.fhir.database.utils.query.QueryTest.FOO_ID;
import static net.sovrinhealth.fhir.database.utils.query.QueryTest.FOO_NAME;
import static net.sovrinhealth.fhir.database.utils.query.QueryTest.FOO_TAB;
import static net.sovrinhealth.fhir.database.utils.query.QueryTest.FOO_TOWN;
