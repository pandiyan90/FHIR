...
package net.sovrinhealth.fhir.validation;
...
import static net.sovrinhealth.fhir.path.util.FHIRPathUtil.getRootResourceNode;
...
import static net.sovrinhealth.fhir.validation.util.FHIRValidationUtil.ISSUE_COMPARATOR;
...
import net.sovrinhealth.fhir.model.annotation.Constraint.FHIRPathConstraintValidator;
...
/**
 * A validator that uses conformance resources from the {@link net.sovrinhealth.fhir.registry.FHIRRegistry}
