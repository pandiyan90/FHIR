...
package net.sovrinhealth.fhir.persistence.jdbc.test.erase;
...
import net.sovrinhealth.fhir.persistence.jdbc.connection.FHIRDbFlavorImpl;
...
import net.sovrinhealth.fhir.schema.app.util.CommonUtil;
 ...
 * Example output:
 * <code>
 * May 12, 2021 1:36:39 PM net.sovrinhealth.fhir.persistence.jdbc.test.erase.EraseTestMain createConnection
