...
public class UpdateOperation extends BaseOperation {
     ...
     */
    private <T extends Resource> T copyAndSetResourceMetaFields(T resource, String logicalId, int newVersionNumber, net.sovrinhealth.fhir.model.type.Instant lastUpdated) {
