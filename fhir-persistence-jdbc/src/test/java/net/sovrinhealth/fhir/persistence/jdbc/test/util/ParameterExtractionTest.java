...
public class ParameterExtractionTest {
    ...
    public void testBoolean() throws FHIRPersistenceProcessorException {
        ...
        net.sovrinhealth.fhir.model.type.Boolean.TRUE.accept(parameterBuilder);
        ...
        assertNullValueReturnsNoParameters(tokenSearchParam, net.sovrinhealth.fhir.model.type.Boolean.builder());
    }
    ...
    public void testString() throws FHIRPersistenceProcessorException {
        JDBCParameterBuildingVisitor parameterBuilder;
        net.sovrinhealth.fhir.model.type.String stringVal = string(SAMPLE_STRING);
        List<ExtractedParameterValue> params;
    ...
    public void testString_null() throws FHIRPersistenceProcessorException {
        assertNullValueReturnsNoParameters(stringSearchParam, net.sovrinhealth.fhir.model.type.String.builder());
        assertNullValueReturnsNoParameters(tokenSearchParam, net.sovrinhealth.fhir.model.type.String.builder());
    }
