...
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.LATITUDE_VALUE;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.LONGITUDE_VALUE;
...
import net.sovrinhealth.fhir.search.location.bounding.BoundingBox;
import net.sovrinhealth.fhir.search.location.bounding.BoundingMissing;
