...
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.LIKE;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.modifierOperatorMap;
...
import net.sovrinhealth.fhir.persistence.jdbc.connection.QueryHints;
import net.sovrinhealth.fhir.persistence.jdbc.dao.api.JDBCIdentityCache;
import net.sovrinhealth.fhir.persistence.jdbc.domain.CanonicalSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.ChainedSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.CompositeSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.DateSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.DomainSortParameter;
import net.sovrinhealth.fhir.persistence.jdbc.domain.IdSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.InclusionSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.LastUpdatedSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.LocationSearchExtension;
import net.sovrinhealth.fhir.persistence.jdbc.domain.LocationSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.MissingSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.NumberSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.QuantitySearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.QueryData;
import net.sovrinhealth.fhir.persistence.jdbc.domain.ReferenceSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SearchCountQuery;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SearchDataQuery;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SearchIncludeQuery;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SearchQuery;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SearchQueryRenderer;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SearchSortQuery;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SearchWholeSystemDataQuery;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SearchWholeSystemFilterQuery;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SearchWholeSystemQuery;
import net.sovrinhealth.fhir.persistence.jdbc.domain.SecuritySearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.StringSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.TagSearchParam;
import net.sovrinhealth.fhir.persistence.jdbc.domain.TokenSearchParam;
...
import net.sovrinhealth.fhir.search.location.util.LocationUtil;
