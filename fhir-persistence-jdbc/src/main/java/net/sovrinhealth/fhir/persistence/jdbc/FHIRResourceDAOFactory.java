...
import net.sovrinhealth.fhir.database.utils.common.DatabaseTranslatorFactory;
...
import net.sovrinhealth.fhir.persistence.jdbc.citus.CitusResourceDAO;
...
import net.sovrinhealth.fhir.persistence.jdbc.dao.api.FhirSequenceDAO;
...
import net.sovrinhealth.fhir.persistence.jdbc.derby.DerbyCommonValuesDAO;
import net.sovrinhealth.fhir.persistence.jdbc.derby.DerbyResourceDAO;
import net.sovrinhealth.fhir.persistence.jdbc.impl.ParameterTransactionDataImpl;
import net.sovrinhealth.fhir.persistence.jdbc.postgres.PostgresReindexResourceDAO;
import net.sovrinhealth.fhir.persistence.jdbc.postgres.PostgresResourceDAO;
...
public class FHIRResourceDAOFactory {
    ...
    public static FhirSequenceDAO getSequenceDAO(Connection connection, FHIRDbFlavor flavor) {
        ...
        switch (flavor.getType()) {
        case DERBY:
            result = new net.sovrinhealth.fhir.persistence.jdbc.derby.FhirSequenceDAOImpl(connection);
            break;
        case POSTGRESQL:
        case CITUS:
            result = new net.sovrinhealth.fhir.persistence.jdbc.postgres.FhirSequenceDAOImpl(connection);
            break;
        default:
            throw new IllegalArgumentException("Unsupported database type: " + flavor.getType().name());
        }
