...
import static net.sovrinhealth.fhir.model.type.code.SearchParamType.DATE;
import static net.sovrinhealth.fhir.model.type.code.SearchParamType.NUMBER;
import static net.sovrinhealth.fhir.model.type.code.SearchParamType.QUANTITY;
import static net.sovrinhealth.fhir.model.type.code.SearchParamType.REFERENCE;
import static net.sovrinhealth.fhir.model.type.code.SearchParamType.STRING;
import static net.sovrinhealth.fhir.model.type.code.SearchParamType.TOKEN;
import static net.sovrinhealth.fhir.model.type.code.SearchParamType.URI;
import static net.sovrinhealth.fhir.search.date.DateTimeHandler.generateTimestamp;
...
import net.sovrinhealth.fhir.persistence.jdbc.dto.LocationParmVal;
...
public class JDBCParameterBuildingVisitor extends DefaultVisitor {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.Boolean _boolean) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.Canonical canonical) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.Code code) {
        if (code.hasValue()) {
            if (!TOKEN.equals(searchParamType)) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.Date date) {
        if (date.hasValue()) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.DateTime dateTime) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.Decimal decimal) {
        if (decimal.hasValue()) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.Id id) {
        if (id.hasValue()) {
            if (!TOKEN.equals(searchParamType)) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.Instant instant) {
        if (instant.hasValue()) {
            if (!DATE.equals(searchParamType)) {
    ...
    @Override
    public boolean visit(java.lang.String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.Integer integer) {
        if (integer.hasValue()) {
            if (!NUMBER.equals(searchParamType)) {
    ...
    @Override
    public boolean visit(String elementName, int elementIndex, net.sovrinhealth.fhir.model.type.String value) {
        if (value.hasValue()) {
    ...
    public boolean visit(java.lang.String elementName, int elementIndex, Address address) {
        ...
        for (net.sovrinhealth.fhir.model.type.String aLine : address.getLine()) {
            p = new StringParmVal();
            p.setResourceType(resourceType);
            p.setName(searchParamCode);
            p.setUrl(searchParamUrl);
    ...
    public boolean visit(java.lang.String elementName, int elementIndex, HumanName humanName) {
        ...
        for (net.sovrinhealth.fhir.model.type.String given : humanName.getGiven()) {
            p = new StringParmVal();
            p.setResourceType(resourceType);
            p.setName(searchParamCode);
            p.setUrl(searchParamUrl);
        ...
        for (net.sovrinhealth.fhir.model.type.String prefix : humanName.getPrefix()) {
            p = new StringParmVal();
            p.setResourceType(resourceType);
            p.setName(searchParamCode);
            p.setUrl(searchParamUrl);
        ...
        for (net.sovrinhealth.fhir.model.type.String suffix : humanName.getSuffix()) {
            p = new StringParmVal();
            p.setResourceType(resourceType);
            p.setName(searchParamCode);
            p.setUrl(searchParamUrl);
