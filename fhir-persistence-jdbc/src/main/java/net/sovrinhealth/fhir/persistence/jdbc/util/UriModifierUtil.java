...
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.BIND_VAR;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.COMMA_CHAR;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.EQ;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.IN;
...
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.OR;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.PATH_CHAR;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.RIGHT_PAREN;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.SPACE;
