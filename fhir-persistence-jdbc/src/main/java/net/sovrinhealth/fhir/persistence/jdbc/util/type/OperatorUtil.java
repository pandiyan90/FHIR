...
package net.sovrinhealth.fhir.persistence.jdbc.util.type;

import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.EQ;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.GT;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.GTE;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.LIKE;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.LT;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.LTE;
import static net.sovrinhealth.fhir.persistence.jdbc.JDBCConstants.NE;
